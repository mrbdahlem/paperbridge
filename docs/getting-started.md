...
Outside devcontainers both commands bind to `localhost`; devcontainers set `VITE_DEV_HOST=0.0.0.0`, `VITE_PREVIEW_HOST=0.0.0.0`, and `VITE_PREVIEW_PORT=3000` so forwarded ports are reachable from the host machine.
